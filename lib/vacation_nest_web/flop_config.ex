defmodule VacationNestWeb.FlopConfig do
  def table_opts do
    [
      table_attrs: [class: "w-full text-center text-gray-500 mx-auto"],
      thead_th_attrs: [class: "px-6 py-3"],
      thead_tr_attrs: [
        class: "font-semibold text-gray-700 uppercase bg-gray-50"
      ],
      tbody_td_attrs: [
        class: "px-5 py-3 font-medium text-gray-900 whitespace-nowrap "
      ],
      tbody_tr_attrs: [class: "bg-white border-b"]
    ]
  end
  ...
  def pagination_opts do
    [
      ...
      current_link_attrs: [
        class:
          "text-brand inline-flex items-center justify-center px-4 h-10 ms-0 leading-tight text-amber-600 bg-amber-50 pointer-events-none border border-gray-300"
      ],
      next_link_attrs: [
        class:
          "flex items-center justify-center px-4 h-10 ms-0 leading-tight hover:bg-gray-100 hover:text-gray-700 border border-e-0 border-gray-300 rounded-s-lg"
