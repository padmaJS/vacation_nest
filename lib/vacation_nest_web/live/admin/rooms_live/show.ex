defmodule VacationNestWeb.Admin.RoomsLive.Show do
  ...
  def render(assigns) do
    ...
    <div class="mx-auto w-3/4 my-4">
      <div class="flex flex-col space-y-6">
        <div class="grid grid-cols-3 bg-gray-10 p-4 shadow-xl rounded-lg gap-4">
    ...
    <div class="p-4 grid grid-cols-1 justify-items-center gap-4 bg-gray-50 shadow-lg rounded-lg m-8 mx-auto w-[60%]">
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    {:ok,
     socket
     |> assign(:current_page, :rooms)
     |> assign(:room, room)
     |> assign(:bookings, room.bookings)}
  end
end
