defmodule VacationNestWeb.HotelsLive.Show do
  ...
  def render(assigns) do
        ...
        <div class="mt-4 border-t pt-4">
          ...
          <%= for review <- @reviews do %>
            <div class="flex flex-col border-b py-4 px-4 hover:bg-gray-100">
              <div class="flex items-center mb-2">
                <span class="font-bold text-gray-800 text-lg flex space-x-1 items-center">
                  <img src={review.user.profile_image} class="w-[20px] h-[20px] rounded-full" /><a href={
                    ~p"/users/profile/#{review.user.id}"
                  }>
                    <%= review.user.email %>
                  </a>
                </span>
    ...
    <div class="grid grid-cols-2 bg-[#262626] p-5 !px-10 text-white">
      <div class="">
